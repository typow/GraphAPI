...
/**
 * An EdgeHeapNode has a weight of the edge and the two vertices that make up
 * the edge.
 * 
 * @author Donald Chinn
...
public class EdgeHeapNode implements Comparable {
	 ...
	 * @param v1
	 *            the first vertex that makes up the edge
	 * @param v2
	 *            the second vertex that makes up the edge
	 * 
	 */
